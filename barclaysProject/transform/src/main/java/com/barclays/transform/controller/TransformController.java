...
public class TransformController {
	...
	@RequestMapping(value = {
			"/transformService" }, method = RequestMethod.POST, consumes = "application/json", produces = "application/json")
	public ResponseEntity<InternalServiceResponse> payPublicService(
		...
		InternalRequest internalRequest = inteService.getInternalRequest();
		...
		String transformResult = transformService.TransformXSLT(internalService.getServiceType(),
				internalRequest.getOperation(), internalRequest.getMessageType(), internalRequest.getMessage());
